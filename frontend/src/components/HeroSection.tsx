  ...
  const detectLocation = async () => {
    ...
    navigator.geolocation.getCurrentPosition(
      async (position) => {
        ...
        try {
          // Use Google's Reverse Geocoding API
          ...
          if (data.status === 'OK' && data.results.length > 0) {
            ...
            setLocation(`${locationName}, ${country} (${latitude.toFixed(4)}, ${longitude.toFixed(4)})`)
          } else {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div>
              ...
              <button 
                ...
                className="w-full px-4 py-3 rounded-lg text-left text-gray-700 flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed btn-3d btn-3d-detect"
              >
                {isDetecting ? (
                  <>
            ...
            <div>
              ...
              <select className="w-full px-4 py-3 rounded-lg text-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 transition-all btn-3d btn-3d-detect cursor-pointer">
            ...
            <div className="flex items-end">
              <button className="w-full text-white px-6 py-3 rounded-lg font-medium transition-all btn-3d btn-3d-primary">
                Get Recommendations
              </button>
            </div>
          </div>
